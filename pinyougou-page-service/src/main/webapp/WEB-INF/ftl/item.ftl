            ...
            <div class="fl preview-wrap">
                ...
                <div class="zoom">
                    ...
                    <div id="preview" class="spec-preview">
							<#if (imgList?size>0)>
                                <span class="jqzoom"><img jqimg="${imgList[0].url}" src="${imgList[0].url}"
            ...
            <div class="fr itemInfo-wrap">
                ...
                <div class="clearfix choose">
                    <div id="specification" class="summary-wrap clearfix">
							...
							<#list specificationItemsList as specificationItems>
                                <dl>
                                    <dt>
                                        <div class="fl title">
                                            <i>${specificationItems.attributeName}</i>
                                        </div>
                                    </dt>
									<#list specificationItems.attributeValue as value><#--class="selected"-->
									     <dd>
                                             <a class="{{isSelected('${specificationItems.attributeName}','${value}')?'selected':''}}"
                                                href="javascript:void (0);"
                                                ng-click="selectSpecification('${specificationItems.attributeName}','${value}')">${value}
                    ...
                    <div class="summary-wrap">
                        <div class="fl title">
                            <div class="control-group">
                                <div class="controls">
                                    <input autocomplete="off" type="text" class="itxt" value="{{num}}"/>
                                    <a href="javascript:void(0)" class="increment plus" ng-click="num(1)">+</a>
                                    <a href="javascript:void(0)" class="increment mins" ng-click="num(-1)">-</a>
                                </div>
                            </div>
                        </div>
                        <div class="fl">
